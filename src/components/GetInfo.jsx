                  ...
                  <div key={index} className="p-4 border-2 rounded space-y-4 dark:border-slate-700">
                    ...
                    <div className="space-y-2">
                      <div className="peer">
                        <Suggestions
                          label="Degree Name"
                          placeholder="Bachelor in computer application (BCA)"
